...
const BREAKS = {
  ...
  'value-back-to-13': {
    ...
    reddens: [
      ...
      'render/registrationTypeScale › the probe’s table of type pairs IS the scale the components ship',
  ...
  'heading-not-smaller': {
    ...
    reddens: [
      ...
      'render/registrationTypeScale › the probe’s table of type pairs IS the scale the components ship',
      'render/registrationTypeScale › the renamed card heading fits its header row without truncating',
      'fs/tailwindArbitraryValueRules › the measured geometry really is in the harvest, not merely a large count',
    ],
  ...
  'rename-reverted': {
    ...
    reddens: [
      ...
      'render/registrationTypeScale › the renamed card heading fits its header row without truncating (no — see staysGreen)',
    ],
  ...
  'copy-gated-by-lock': {
    ...
    reddens: [
      ...
      'render/registrationDetailShell › the public ข้อมูลสำหรับออกใบเสนอราคา card carries NO quotation number (check: only if a cancelled fixture is read there)',
    ],
