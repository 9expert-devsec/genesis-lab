...
/**
 * `targetAudienceRich` renders IN PLACE OF the plain `course_target_audience`
 ...
 */
export function CourseTarget({ course, extension }) {
  const richBody = sanitizeRichHtml(extension?.targetAudienceRich ?? '');
