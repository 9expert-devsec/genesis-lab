...
function TrainingTypeLegend() {
  return (
    <div className="mb-3 flex items-center justify-end gap-3 text-sm text-9e-slate-dp-50">
      ...
      <div className="group relative">
        <button
          ...
          className="flex h-5 w-5 items-center justify-center rounded-full border border-9e-slate-lt-400 dark:border-9e-slate-dp-400 text-sm text-9e-slate-dp-50 transition-colors duration-9e-micro ease-9e hover:border-9e-action hover:text-9e-action focus:outline-none focus:ring-2 focus:ring-9e-action/20"
        >
          ?
        </button>
        ...
        <div className="pointer-events-none invisible absolute bottom-full right-0 z-50 mb-2 w-80 opacity-0 transition-all duration-9e-micro ease-9e group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-4 text-left shadow-9e-md">
            <div className="space-y-3">
              <div>
                <p className="mb-0.5 flex items-center gap-1.5 text-sm font-bold text-9e-navy">
                  <span className="inline-block h-2 w-2 rounded-full bg-9e-action" />
                  Classroom
                </p>
                <p className="text-sm leading-relaxed text-9e-slate-dp-50">
