...
const DATA_CATEGORIES = [
  ...
  },
  {
    ...
    detail: 'ประวัติการสั่งซื้อ, วิธีการชำระเงิน, รหัสอ้างอิงรายการชำระเงินจากผู้ให้บริการ และข้อมูลที่ปรากฏในหลักฐานการโอนเงิน/สลิปเท่าที่จำเป็นสำหรับตรวจสอบการชำระเงิน โดยบริษัทไม่จัดเก็บหมายเลขบัตรเครดิต/เดบิต หรือเลขที่บัญชีธนาคารของท่าน',
  },
  {
              ...
              body: (
                <>
                  ...
                  <p className="mt-4 rounded-xl bg-[var(--surface-muted)] px-4 py-3 text-[13px]">
                    ...
                    นับจากวันที่ได้รับข้อมูลครบถ้วนสำหรับพิสูจน์ตัวตนของท่าน
                    หากบริษัทไม่สามารถดำเนินการตามคำร้องขอได้ไม่ว่าทั้งหมดหรือบางส่วน
                    บริษัทจะแจ้งเหตุผลให้ท่านทราบ
                    ท่านสามารถใช้สิทธิและติดตามสถานะคำร้องขอผ่านช่องทางติดต่อในข้อ 14
                  </p>
                </>
              ),
            },
