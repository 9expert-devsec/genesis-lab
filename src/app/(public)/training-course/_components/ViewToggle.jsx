    ...
    <button
      ...
      className={cn(
        ...
        active
          ...
          : 'border border-gray-200 bg-white text-9e-slate hover:border-9e-brand hover:text-9e-brand dark:border-[#1e3a5f] dark:bg-[#111d2c] dark:text-[#94a3b8] dark:hover:border-9e-air dark:hover:text-9e-air'
      )}
    >
      {children}
    </button>
